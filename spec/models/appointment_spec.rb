...
describe Appointment do
  ...
  before do
    ...
    10.times do
      @appointment.styles.create(quantity: Faker::Number.number(Random.rand(1...3)), negotiated_cost: Faker::Number.decimal(2), 
          wholesale_cost: Faker::Number.decimal(2), retail_price: Faker::Number.decimal(2) )
    end
  end
  ...
  it "calculates weighted average IMU" do
    ...
    imu = sumproduct / @appointment.styles.sum(:quantity) 
  ...
  it "calculates average initial retail" do
    ...
    air = sumproduct / @appointment.styles.sum(:quantity)
